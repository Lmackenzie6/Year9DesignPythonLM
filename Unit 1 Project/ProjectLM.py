...
button9 = tk.Button(text="1", highlightbackground="#233C6A")
button9.grid(row=9, column=2)
button10 = tk.Button(text="2", highlightbackground="#233C6A")
button10.grid(row=10, column=2)
button11 = tk.Button(text="3", highlightbackground="#233C6A")
button11.grid(row=11, column=2)
button12 = tk.Button(text="4", highlightbackground="#233C6A")
